...
For the smaller version that excludes the plotting option, see https://drive.google.com/file/d/15d7Z4mWZVjuWui5OcIWU-jvakCuUDoAn/view?usp=sharing
...
# Requires version 3.2.2 to build the exe
...
def get_query():
    ...
    query = input("").upper()
    while query not in ("T", "D", "E"):
        print("Please enter T, D, or E")
        query = input("").upper()
...
def make_histogram(sending, receiving):
    """Plot a histogram of card values. Requires matplotlib"""
